...
*/
            if (!Constants.Defined("_AVR_IO_H_"))
            {
                ...
                Sfr_defs.InitConstants();
                if (1 == 0)   /// Заглушка
                    ;

                //                if (Constants.Defined("__AVR_AT94K__"))
                //                    Constants.ioat94k.InitConstants();
                //                else
                //                if (Constants.Defined("__AVR_AT43USB320__"))
                //                    Constants.io43u32x.InitConstants();
                //                else
                //                if (defined("__AVR_AT43USB355__"))
                //                    io43u35x.InitConstants();
                //                else
                //                if (defined("__AVR_AT76C711__"))
                //                    io76c711.InitConstants();
                //                else
                //                if (defined("__AVR_AT86RF401__"))
                //                    io86r401.InitConstants();
                ...
                if (Constants.Defined("__AVR_ATmega328P__") || Constants.Defined("__AVR_ATmega328__"))
                ...
                //else
                //if (Constants.Defined("__AVR_ATmega8__")
                //    iom8.InitConstants();
