 ...
 */
static void
hc595_spi_in_hook (struct avr_irq_t *irq, uint32_t value, void *param)
{
 ...
 */
static void
hc595_latch_hook (struct avr_irq_t *irq, uint32_t value, void *param)
{
  hc595_t *p = (hc595_t *) param;
  if (irq->value && !value)
    {   // falling edge
 ...
 */
static void
hc595_reset_hook (struct avr_irq_t *irq, uint32_t value, void *param)
{
  hc595_t *p = (hc595_t *) param;
...
void
hc595_init (struct avr_t *avr, hc595_t * p)
{
