...
void stepper_init (struct avr_t *avr, stepper_p p, char *name, float steps_per_mm, float start_position,   // mm
...
void stepper_connect (stepper_p p,
                      avr_irq_t * step, avr_irq_t * dir, avr_irq_t * enable, avr_irq_t * endstop,
                      uint16_t flags);

float stepper_get_position_mm (stepper_p p);
