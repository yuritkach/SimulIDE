...
/*
 * Tests the TWI using a commonly used and non-interrupt driven alternative to the Atmel driver:
 *
...
{
  /*
   * This init followed by a start condition is enough to overwrite all TWI related bits set by
   * TWI_Master_Initialise () in the Atmel driver.
   */
  i2c_init();
...
int main()
{
  ...
  /*
   * This should produce *exactly* the same output as above, except the data written should be D00D
   * as opposed to DEAD.
   */
