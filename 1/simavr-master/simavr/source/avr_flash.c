...
avr_progen_clear (struct avr_t *avr, avr_cycle_count_t when, void *param)
{
...
static void
avr_flash_write (avr_t * avr, avr_io_addr_t addr, uint8_t v, void *param)
{
  avr_flash_t *p = (avr_flash_t *) param;
...
static void
avr_flash_clear_temppage (avr_flash_t * p)
{
...
static int
avr_flash_ioctl (struct avr_io_t *port, uint32_t ctl, void *io_param)
{
...
void
avr_flash_init (avr_t * avr, avr_flash_t * p)
{
  p->io = _io;
