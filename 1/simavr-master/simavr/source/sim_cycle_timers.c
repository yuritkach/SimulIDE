...
void
avr_cycle_timer_reset (struct avr_t *avr)
{
...
avr_cycle_timer_return_sleep_run_cycles_limited (avr_t * avr, avr_cycle_count_t sleep_cycle_count)
{
...
static void
avr_cycle_timer_reset_sleep_run_cycles_limited (avr_t * avr)
{
  avr_cycle_timer_pool_t *pool = &avr->cycle_timers;
...
static void
avr_cycle_timer_insert (avr_t * avr, avr_cycle_count_t when, avr_cycle_timer_t timer, void *param)
{
  avr_cycle_timer_pool_t *pool = &avr->cycle_timers;
...
void
avr_cycle_timer_register (avr_t * avr, avr_cycle_count_t when, avr_cycle_timer_t timer, void *param)
{
  avr_cycle_timer_pool_t *pool = &avr->cycle_timers;
...
void
avr_cycle_timer_register_usec (avr_t * avr, uint32_t when, avr_cycle_timer_t timer, void *param)
{
  avr_cycle_timer_register (avr, avr_usec_to_cycles (avr, when), timer, param);
}

void
avr_cycle_timer_cancel (avr_t * avr, avr_cycle_timer_t timer, void *param)
{
  avr_cycle_timer_pool_t *pool = &avr->cycle_timers;
