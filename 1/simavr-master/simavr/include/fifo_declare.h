...
#define FIFO_NULL { FIFO_ZERO_INIT, 0, 0, 0 }
  ...
  /* New compilers don't like unused static functions. However, we do like 'static inlines' for
   * these small accessors, so we mark them as 'unused'. It stops it complaining */
#ifdef __GNUC__
